...
<section class="page-section portfolio" id="portfolio">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <!-- Portfolio Items-->
            <?php echo FHomeView::DisplayItineraries(FItineraryManager::GetInstance()->GetAll());?>
        </div>
    </div>
</section>
<!-- Portfolio Modal-->
<?php echo FHomeView::DisplayModalItineraries(FItineraryManager::GetInstance()->GetAll());?>
